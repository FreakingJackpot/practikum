...
class Category(models.Model):
    ...
    class Color(models.Model):
        ...
        preview = models.OneToOneField(Image, verbose_name='Изображение', on_delete=models.CASCADE,
                                       related_name='color',
    ...
    class Request(models.Model):
        ...
        status = models.CharField(max_length=100, choices=REQUESTS_CHOICES, default='UNCOMPLETED',
                                  verbose_name='Статус')
